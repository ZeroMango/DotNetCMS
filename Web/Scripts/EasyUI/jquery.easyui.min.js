...
(function ($) {
    ...
    $.fn.droppable.defaults = {
        accept: null, disabled: false, onDragEnter: function (e, _50) {
...
(function ($) {
    ...
    $.fn.pagination.defaults = {
        total: 1, pageSize: 10, pageNumber: 1, pageList: [10, 20, 30, 50], loading: false, buttons: null, showPageList: true, showRefresh: true, onSelectPage: function (_9c, _9d) {
...
(function ($) {
    ...
    function _c1(_c2) {
        ...
        _c5.find("div.tree-node").draggable({
            disabled: false, revert: true, cursor: "pointer", proxy: function (_c6) {
            ...
            accept: "div.tree-node", onDragEnter: function (e, _ca) {
    ...
    $.fn.tree.defaults = {
        url: null, method: "post", animate: false, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, dnd: false, data: null, formatter: function (node) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _18a, dataType: "json", success: function (data) {
                    _18b(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.progressbar.defaults = {
        width: "auto", height: 22, value: 0, text: "{value}%", onChange: function (_1a9, _1aa) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    function _22d(_22e) {
        ...
        var win = $(_22e).panel($.extend({}, _22f.options, {
            border: false, doSize: true, closed: true, cls: "window", headerCls: "window-header", bodyCls: "window-body " + (_22f.options.noheader ? "window-body-noheader" : ""), onBeforeDestroy: function () {
    ...
    function _233(_234) {
        ...
        _235.window.draggable({
            handle: ">div.panel-header>div.panel-title", disabled: _235.options.draggable == false, onStartDrag: function (e) {
                if (_235.mask) {
        ...
        _235.window.resizable({
            disabled: _235.options.resizable == false, onStartResize: function (e) {
...
(function ($) {
    ...
    function _242(_243) {
        ...
        opts.content = null;
        _244.panel({
            closed: opts.closed, cache: opts.cache, href: _248, content: _249, onLoad: function () {
                if (opts.height == "auto") {
                    $(_243).window("resize");
                }
...
(function ($) {
    ...
    function _25e(_25f, _260, _261) {
        ...
        win.window({
            title: _25f, noheader: (_25f ? false : true), width: 300, height: "auto", modal: true, collapsible: false, minimizable: false, maximizable: false, resizable: false, onClose: function () {
                setTimeout(function () {
                    win.window("destroy");
                }, 100);
            }
...
(function ($) {
    ...
    function _28c(_28d, pp, _28e) {
        pp.panel($.extend({}, _28e, {
            collapsible: false, minimizable: false, maximizable: false, closable: false, doSize: false, collapsed: true, headerCls: "accordion-header", bodyCls: "accordion-body", onBeforeExpand: function () {
                var curr = _278(_28d);
                if (curr) {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, onSelect: function (_2b3, _2b4) {
...
(function ($) {
    ...
    function _2d9(_2da, pp, _2db) {
        ...
        pp.panel($.extend({}, _2db, {
            border: false, noheader: true, closed: true, doSize: false, iconCls: (_2db.icon ? _2db.icon : undefined), onLoad: function () {
                if (_2db.onLoad) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, plain: false, fit: false, border: true, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_313) {
    ...
    function _331(_332, _333, el) {
        ...
        if (pp.panel("options").split) {
            ...
            _337.resizable($.extend({}, {
                handles: _338, onStartResize: function (e) {
                    _320 = true;
...
(function ($) {
    ...
    $.fn.searchbox.defaults = {
        width: "auto", height: 22, prompt: "", value: "", menu: null, searcher: function (_3c9, name) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, delay: 200, missingMessage: "This field is required.", invalidMessage: null, tipPosition: "right", deltaX: 0, tipOptions: {
            ...
            email: {
                ...
                validator: function (_3e8) {
                    return /^[^\\/:*?"<>|]{1,255}$/i.test(_3e8);
                }, message: "请输入正确的文件名."
            }, english: {
                validator: function (_3e8) {
                    return /^[\w\d]{1,255}$/i.test(_3e8);
                }, message: "请输入正确的文件名."
            }
        }
    };
...
(function ($) {
    ...
    function load(_3f7, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _3f8, dataType: "json", success: function (data) {
                    _3f9(data);
                }, error: function () {
    ...
    $.fn.form.defaults = {
        url: null, onSubmit: function (_409) {
...
(function ($) {
    ...
    function _4c9(_4ca) {
        ...
        _4cc.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_4cd, _4ce) {
                setTimeout(function () {
        ...
        if (opts.pagination) {
            ...
            _4d1.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_4d2, _4d3) {
    ...
    function _4db(_4dc) {
        ...
        _4e0.each(function () {
            $(this).resizable({
                handles: _4e4, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _4dd.resizing = true;
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", rownumbers: false, singleSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowStyler: function (_666, _667) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _668, dataType: "json", success: function (data) {
                    _669(data);
                }, error: function () {
...
(function ($) {
    ...
    function _692(_693) {
        ...
        $(_693).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? _695 : undefined), onClickRow: function (_696, row) {
                if (_691 != this) {
                    _697(_691);
                    _691 = this;
                }
    ...
    var _695 = $.extend({}, $.fn.datagrid.defaults.view, {
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        singleSelect: true, remoteSort: false, fitColumns: true, loadMsg: "", frozenColumns: [[{ field: "f", width: 16, resizable: false }]], columns: [[{ field: "name", title: "Name", width: 100, sortable: true }, { field: "value", title: "Value", width: 100, resizable: false }]], showGroup: false, groupField: "group", groupFormatter: function (_6bd, rows) {
            return _6bd;
        }
    });
})(jQuery);
(function ($) {
    function _6be(_6bf) {
        ...
        if (opts.pagination) {
            ...
            _6d4.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_6d5, _6d6) {
    ...
    var _748 = $.extend({}, $.fn.datagrid.defaults.view, {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, animate: false, singleSelect: true, view: _748, loader: function (_77b, _77c, _77d) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _77b, dataType: "json", success: function (data) {
                    _77c(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", mode: "local", method: "post", url: null, data: null, keyHandler: {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _811, dataType: "json", success: function (data) {
                    _812(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, value: 0, min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_8b9) {
            return _8b9;
